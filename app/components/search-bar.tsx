...
export function SearchBar({ profile }: props) {
    ...
    return (
        ...
        <form className="w-full px-6 flex items-center gap-x-4 border-b-4 border-b-blue-900 border-opacity-30 h-20">
              <form action={(`home/snippet/${user.id}`)} >
            ...
            <div className="flex-1" />
             ...
             <form action="home/profile" >
                    <button type="submit" className="rounded-xl bg-blue-300 font-semibold text-blue-600 px-3 py-2 transition duration-300 ease-in-out">
